%% savePathGamma
% Saves a path, transformations of the endpoint and associated splineData
% to a file.
%
...
%       Path to save
%   gamma
%       Transformations of the endoint
%   splineData
...
function savePathGamma( name, dPath, gamma, splineData, varargin )
