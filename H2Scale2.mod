# scale invariant H2 Metric, with length as a constraint 
...
# CONSTRAINTS
# length[t] equals the length of the curve 

subject to curvelength {t in QT}: 
  sum {p in QP} W[t,p] *norm_cp[t,p] - length[t] = 0;
